...
//        list.printAll();
        String s = "마담 프루스트의 비밀정원";
        MovieMediaManager mmm = new Adapter("MovieMedia.data"); // 위에 주석처리된 3개의 행을 Adapter패턴으로 MovieMediaManagerFile을 처리 Adapter를 만들어야함
	...
	// data파일에 맨 첫번째줄에 있는 숫자 10, 2번째줄부터 10번째쭐까지 9개가 하나의 데이터이다.
        ...
        System.out.println("Printing 3th item");
        mmm.print(3); // 0번째 data출력  
